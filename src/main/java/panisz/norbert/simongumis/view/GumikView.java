...
public class GumikView extends HorizontalLayout {
    ...
    private void ment(){
        ...
        if(hiba==null){
            ...
            gumi.setMeret(meret1.getValue()+"/"+meret2.getValue()+"/R/"+meret3.getValue());
    ...
    static String getString(TextField gyarto, ComboBox evszak, ComboBox allapot, TextField ar, TextField darab, TextField meret1, TextField meret2, TextField meret3) {
        ...
        if(meret1.isEmpty() || Integer.valueOf(meret1.getValue())<135 || Integer.valueOf(meret1.getValue())>315 || (Integer.valueOf(meret1.getValue())%5)!=0){
    ...
    private void szerkesztesMentese(GumikEntity gumikEntity, GumiSzerkesztoView gumiSzerkesztoView){
        ...
        if(leiras == null){
            alapGumikRepository.save(gumiSzerkesztoView.beallit(gumikEntity));
            gridRefresh();
